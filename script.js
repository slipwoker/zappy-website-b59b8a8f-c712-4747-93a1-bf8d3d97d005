document.addEventListener('DOMContentLoaded', function () {
  ...
  const OBSERVE_TARGETS = '.fade-in, [data-animate], .animate-on-scroll';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b59b8a8f-c712-4747-93a1-bf8d3d97d005',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b59b8a8f-c712-4747-93a1-bf8d3d97d005';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b59b8a8f-c712-4747-93a1-bf8d3d97d005';
